    ...
    <div class="flex justify-between items-center">
      ...
      <nav>
        <ul class="flex gap-[32px] justify-between items-center text-[#5c5c5c]">
          ...
          <li class="group flex items-center gap-[10px] cursor-pointer hover:text-[#87c20a] transition duration-500"
            @click="cartStore.openCart">
            <div>
              <svg class="w-5 h-5 stroke-[#9B9B9B] group-hover:stroke-[#87c20a] transition duration-500" width="20"
                height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="currentColor">
                <path
          ...
          <li class="group hover:text-[#87c20a] transition duration-500">
            <RouterLink to="/favorite" class="flex items-center gap-[10px]">
              <svg class="w-5 h-5 fill-[#9B9B9B] group-hover:fill-[#87c20a] transition duration-500" width="22"
                height="19" viewBox="0 0 22 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <li class="group hover:text-[#87c20a] transition duration-500">
            <RouterLink to="/profile" class="flex items-center gap-[10px]">
              <svg class="w-5 h-5 fill-[#9B9B9B] group-hover:fill-[#87c20a] transition duration-500" width="20"
